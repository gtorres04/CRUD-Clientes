 ...
 */
public class ConsultarParaModificarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            paginaSiguiente="modificarClientes.jsp";
        } catch (SQLException ex) {
            request.setAttribute("entidad", entidad);
            request.setAttribute("tipoMsn","Error");
            request.setAttribute("msn", "Consulta Para Modificacion de Cliente Fallida-->"+ex.getMessage());
            System.out.println("EXCEPTION AL MOMENTO DE CONSULTAR PARA MODIFICACION DE UN CLIENTE-->" + ex.getMessage());
        }
