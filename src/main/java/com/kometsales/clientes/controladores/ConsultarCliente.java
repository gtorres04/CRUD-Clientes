...
public class ConsultarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            paginaSiguiente="consultarClientes.jsp";
        } catch (SQLException ex) {
            request.setAttribute("entidad", entidad);
            request.setAttribute("tipoMsn","Error");
            request.setAttribute("msn", "Consulta de Cliente Fallida-->"+ex.getMessage());
            System.out.println("EXCEPTION AL MOMENTO DE CONSULTAR UN CLIENTE-->" + ex.getMessage());
        }
