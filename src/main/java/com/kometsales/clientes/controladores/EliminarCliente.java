...
public class EliminarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            clienteServicio.eliminar(entidad);
            request.setAttribute("entidad", entidad);
            request.setAttribute("tipoMsn","Exito");
            request.setAttribute("msn", "Eliminacion Exitosa");
        } catch (SQLException ex) {
            request.setAttribute("entidad", entidad);
            request.setAttribute("tipoMsn","Error");
            request.setAttribute("msn", "Eliminacion Fallida-->"+ex.getMessage());
            System.out.println("EXCEPTION AL MOMENTO DE ELIMINAR UN CLIENTE-->" + ex.getMessage());
        }
